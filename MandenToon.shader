Shader "Manden/MandenToon"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 Toon(float3 normal, float3 lightDir, float4 base, float4 sss, fixed shadow) 
            {
                ...
                float r1 = remap(0.0, _WhiteLevel, 0.0, 1.0, NdotL * shadow);
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float4 col = Toon(i.worldNormal, _WorldSpaceLightPos0.xyz, base, sss, shadow);
                return col;
            }
            ENDCG
        }
